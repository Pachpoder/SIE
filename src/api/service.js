...
const Services = [
    {
        ...
        sImgS:sImgS1,
        sTitle: 'Misión',
        description:'Desarrollar una eficiente gestión, producto de la aplicación de principios, valores bíblicos y empresariales, que nos comprometen con pasión a desarrollar los productos de alta calidad que garanticen la satisfacción de nuestros clientes.',
    ...
    },
    {
        ...
        sImgS:sImgS2,
        sTitle: 'Visión',
        description:'Ser una compañía Farmacéutica próspera para sus socios y colaboradores',
        des2:'Lacus, etiam sed est eu tempus need Temer diam congue laoret .',
        des3:'One way to categorize the activities is in terms of the professional’s area of expertise such as competitive analysis, corporate strategy the activities',
        icon:'flaticon-team',
        ssImg1:sSingleimg1,
